...
public class EdgeEffectTitlePageIndicator extends TitlePageIndicator {
	public EdgeEffectTitlePageIndicator(Context context) {
		this(context, null);
	}

	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
	public EdgeEffectTitlePageIndicator(Context context, AttributeSet attrs) {
